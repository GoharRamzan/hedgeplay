...
const Features = () => {
    return (
        <div className='bg-[#1A325E] h-full flex flex-col items-center w-full overflow-hidden pb-24 '>
            ...
            <div className='flex justify-between items-center w-[94%] md:w-[80%] h-full bg-[#a9a9b9] rounded-3xl py-9 px-10 md:px-14 '>
