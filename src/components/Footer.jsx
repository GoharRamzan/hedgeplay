            ...
            <div className="max-w-screen-xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:flex flex-col lg:items-center">
                        <h4 className="text-am mb-6 text-white">Social Media</h4>
                        <ul className="flex  space-x-4">
                            ...
                            <li>
                                <Link to="javascript:void(0)">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-300 hover:fill-white w-7 h-7" id="github" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 pl-2">
                            <li>
                                <Link to="javascript:void(0)" className="text-gray-400 hover:text-white text-sm">About Us</Link>
                            </li>
                            <li>
                                <Link to="javascript:void(0)" className="text-gray-400 hover:text-white text-sm">Terms &amp; Conditions</Link>
                            </li>
                            <li>
